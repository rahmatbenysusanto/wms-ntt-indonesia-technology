<!doctype html>
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="@yield('sizeBarSize', 'lg')"
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="#" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('assets/images/maximaz-logo.png') }}" alt=""
                                        height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('assets/images/maximaz-logo.png') }}" alt=""
                            ...
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        ...
                                        <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Admin
                                            Gudang</span>
                                    </span>
                                </span>
                            </button>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <div class="collapse menu-dropdown {{ in_array($title, ['Dashboard', 'Dashboard PO', 'Dashboard Aging', 'Dashboard Outbound']) ? 'show' : '' }}"
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    @if (Session::get('userHasMenu')->contains('PO Dashboard'))
                                        <li class="nav-item">
                                            <a href="{{ route('dashboard.po') }}"
                                                class="nav-link {{ $title == 'Dashboard PO' ? 'active' : '' }}"
                                                data-key="t-analytics"> PO </a>
                                        </li>
                                    @endif
                                    @if (Session::get('userHasMenu')->contains('Aging Dashboard'))
                                        <li class="nav-item">
                                            <a href="{{ route('dashboard.aging') }}"
                                                class="nav-link {{ $title == 'Dashboard Aging' ? 'active' : '' }}"
                                                data-key="t-analytics"> Aging </a>
                                        </li>
                                    @endif
                                    @if (Session::get('userHasMenu')->contains('Outbound Dashboard'))
                                        <li class="nav-item">
                                            <a href="{{ route('dashboard.outbound') }}"
                                                class="nav-link {{ $title == 'Dashboard Outbound' ? 'active' : '' }}"
                                                data-key="t-analytics"> Outbound </a>
                                        </li>
                                    @endif
                                </ul>
                            </div>
                        ...
                        @if (Session::get('userHasMenu', collect())->intersect(['Purchase Order', 'Quality Control', 'Put Away'])->isNotEmpty())
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link {{ in_array($title, ['Purchase Order', 'Quality Control', 'Put Away']) ? 'active' : '' }}"
                                    href="#sidebarInbound" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarInbound">
                                    <i class="mdi mdi-package-down"></i> <span data-key="t-dashboards">Inbound</span>
                                </a>
                                <div class="collapse menu-dropdown {{ in_array($title, ['Purchase Order', 'Quality Control', 'Put Away']) ? 'show' : '' }}"
                                    id="sidebarInbound">
                                    <ul class="nav nav-sm flex-column">
                                        @if (Session::get('userHasMenu')->contains('Purchase Order'))
                                            <li class="nav-item">
                                                <a href="{{ route('inbound.purchase-order') }}"
                                                    class="nav-link {{ in_array($title, ['Purchase Order']) ? 'active' : '' }}"
                                                    data-key="t-analytics"> Purchase Order </a>
                                            </li>
                                        @endif
                                        @if (Session::get('userHasMenu')->contains('Quality Control'))
                                            <li class="nav-item">
                                                <a href="{{ route('inbound.quality-control') }}"
                                                    class="nav-link {{ in_array($title, ['Quality Control']) ? 'active' : '' }}"
                                                    data-key="t-analytics"> Quality Control </a>
                                            </li>
                                        @endif
                                        @if (Session::get('userHasMenu')->contains('Put Away'))
                                            <li class="nav-item">
                                                <a href="{{ route('inbound.put-away') }}"
                                                    class="nav-link {{ in_array($title, ['Put Away']) ? 'active' : '' }}"
                                                    data-key="t-analytics"> Put Away </a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                                ...
                                <div class="collapse menu-dropdown {{ in_array($title, ['Inventory', 'Cycle Count', 'Transfer Location', 'Inventory Box', 'Inventory Aging', 'Update Serial Number']) ? 'show' : '' }}"
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        @if (Session::get('userHasMenu')->contains('Produk List'))
                                            <li class="nav-item">
                                                <a href="{{ route('inventory.index') }}"
                                                    class="nav-link {{ $title == 'Inventory' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Produk List </a>
                                            </li>
                                        @endif
                                        @if (Session::get('userHasMenu')->contains('Produk Aging'))
                                            <li class="nav-item">
                                                <a href="{{ route('inventory.aging') }}"
                                                    class="nav-link {{ $title == 'Inventory Aging' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Produk Aging </a>
                                            </li>
                                        @endif
                                        ...
                                        @if (Session::get('userHasMenu')->contains('Transfer Location'))
                                            <li class="nav-item">
                                                <a href="{{ route('inventory.transfer-location') }}"
                                                    class="nav-link {{ $title == 'Transfer Location' ? 'active' : '' }}"
                        ...
                        @if (Session::get('userHasMenu', collect())->intersect([
                                    'General Room Inventory',
                                    'General Room Outbound',
                                    'PM Room Inventory',
                                    'PM Room Outbound',
                            ...
                            @if (Session::get('userHasMenu', collect())->intersect(['General Room Inventory', 'General Room Outbound'])->isNotEmpty())
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ in_array($title, ['General Room', 'General Room Outbound']) ? 'active' : '' }}"
                                        href="#sidebarGeneralRoom" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarGeneralRoom">
                                        <i class="mdi mdi-book-clock"></i> <span data-key="t-dashboards">General
                                            Room</span>
                                    </a>
                                    <div class="collapse menu-dropdown {{ in_array($title, ['General Room', 'General Room Outbound']) ? 'show' : '' }}"
                                        id="sidebarGeneralRoom">
                                        <ul class="nav nav-sm flex-column">
                                            @if (Session::get('userHasMenu')->contains('General Room Inventory'))
                                                <li class="nav-item">
                                                    <a href="{{ route('general-room.index') }}"
                                                        class="nav-link {{ $title == 'General Room' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Inventory </a>
                                                </li>
                                            @endif
                                            @if (Session::get('userHasMenu')->contains('General Room Outbound'))
                                                <li class="nav-item">
                                                    <a href="{{ route('general-room.outbound') }}"
                                                        class="nav-link {{ $title == 'General Room Outbound' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Outbound </a>
                                                </li>
                                            @endif
                                        </ul>
                            ...
                            @if (Session::get('userHasMenu', collect())->intersect(['PM Room Inventory', 'PM Room Outbound'])->isNotEmpty())
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ in_array($title, ['Pm Room', 'Pm Room Outbound']) ? 'active' : '' }}"
                                        href="#sidebarPmRoom" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarPmRoom">
                                        <i class="mdi mdi-notebook-outline"></i> <span data-key="t-dashboards">PM
                                            Room</span>
                                    </a>
                                    <div class="collapse menu-dropdown {{ in_array($title, ['Pm Room', 'Pm Room Outbound']) ? 'show' : '' }}"
                                        id="sidebarPmRoom">
                                        <ul class="nav nav-sm flex-column">
                                            @if (Session::get('userHasMenu')->contains('PM Room Inventory'))
                                                <li class="nav-item">
                                                    <a href="{{ route('pm-room.index') }}"
                                                        class="nav-link {{ $title == 'Pm Room' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Inventory </a>
                                                </li>
                                            @endif
                                            @if (Session::get('userHasMenu')->contains('PM Room Outbound'))
                                                <li class="nav-item">
                                                    <a href="{{ route('pm-room.outbound') }}"
                                                        class="nav-link {{ $title == 'Pm Room Outbound' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Outbound </a>
                                                </li>
                                            @endif
                                        </ul>
                            ...
                            @if (Session::get('userHasMenu', collect())->intersect(['Spare Room Inventory', 'Spare Room Outbound'])->isNotEmpty())
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ in_array($title, ['Spare Room', 'Spare Room Outbound']) ? 'active' : '' }}"
                                        href="#sidebarSpareRoom" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarSpareRoom">
                                        <i class="mdi mdi-notebook-check-outline"></i> <span
                                            data-key="t-dashboards">Spare Room</span>
                                    </a>
                                    <div class="collapse menu-dropdown {{ in_array($title, ['Spare Room', 'Spare Room Outbound']) ? 'show' : '' }}"
                                        id="sidebarSpareRoom">
                                        <ul class="nav nav-sm flex-column">
                                            @if (Session::get('userHasMenu')->contains('Spare Room Inventory'))
                                                <li class="nav-item">
                                                    <a href="{{ route('spare-room.index') }}"
                                                        class="nav-link {{ $title == 'Spare Room' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Inventory </a>
                                                </li>
                                            @endif
                                            @if (Session::get('userHasMenu')->contains('Spare Room Outbound'))
                                                <li class="nav-item">
                                                    <a href="{{ route('spare-room.outbound') }}"
                                                        class="nav-link {{ $title == 'Spare Room Outbound' ? 'active' : '' }}"
                                                        data-key="t-analytics"> Outbound </a>
                                                </li>
                                            @endif
                                        </ul>
                        ...
                        @if (Session::get('userHasMenu', collect())->intersect(['Vendor', 'Customer'])->isNotEmpty())
                            ...
                            @if (Session::get('userHasMenu')->contains('Vendor'))
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ $title == 'Vendor' ? 'active' : '' }}"
                                        href="{{ route('vendor') }}">
                            ...
                            @if (Session::get('userHasMenu')->contains('Customer'))
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ $title == 'Customer' ? 'active' : '' }}"
                                        href="{{ route('customer') }}">
                                        <i class="mdi mdi-account-group"></i> <span
                                            data-key="t-customer">Customer</span>
                                    </a>
                                </li>
                            @endif
                        @endif
                        ...
                        @if (Session::get('userHasMenu', collect())->intersect(['User', 'Storage'])->isNotEmpty())
                            ...
                            @if (Session::get('userHasMenu')->contains('User'))
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ $title == 'User' ? 'active' : '' }}"
                            ...
                            @if (Session::get('userHasMenu')->contains('Storage'))
                                <li class="nav-item">
                                    <a class="nav-link menu-link {{ in_array($title, ['Storage Raw', 'Storage Area', 'Storage Rak', 'Storage Bin']) ? 'active' : '' }}"
                                        href="#sidebarStorage" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarStorage">
                                        <i class="mdi mdi-database"></i> <span data-key="t-dashboards">Storage</span>
                                    </a>
                                    <div class="collapse menu-dropdown {{ in_array($title, ['Storage Raw', 'Storage Area', 'Storage Rak', 'Storage Bin']) ? 'show' : '' }}"
                                        id="sidebarStorage">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ route('storage.raw') }}"
                                                    class="nav-link {{ $title == 'Storage Raw' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Area </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('storage.area') }}"
                                                    class="nav-link {{ $title == 'Storage Area' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Raw </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('storage.rak') }}"
                                                    class="nav-link {{ $title == 'Storage Rak' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Rak </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('storage.bin') }}"
                                                    class="nav-link {{ $title == 'Storage Bin' ? 'active' : '' }}"
                                                    data-key="t-analytics"> Bin </a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
