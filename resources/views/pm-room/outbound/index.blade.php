                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a href="{{ route('pm-room.outbound-download-pdf', ['id' => $item->id]) }}" class="btn btn-pdf btn-sm" target="_blank">
                                                <span class="mdi mdi-file-pdf-box"></span>
                                            </a>
                                            <a href="{{ route('pm-room.outbound-download-excel', ['id' => $item->id]) }}" class="btn btn-success btn-sm">
