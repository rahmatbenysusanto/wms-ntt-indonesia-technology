...
@section('title', 'Outbound PM Room')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Create PM Room Outbound</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select class="form-control" id="deliveryDest">
                                ...
                                <option value="gr">General Room</option>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary" onclick="createOrder()">Create Order PM Room</a>
                    </div>
                </div>
                <div class="card-body">
        ...
        function createOrder() {
            Swal.fire({
                ...
                if (t.value) {
                    ...
                    $.ajax({
                        url: '{{ route('pm-room.create.outbound') }}',
                        method: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            products: products,
                        ...
                        success: (res) => {
                            if (res.status) {
                                Swal.fire({
                                    title: 'Success',
                                    text: 'Create Order PM Room Successfully',
                                    icon: 'success'
                                }).then((e) => {
