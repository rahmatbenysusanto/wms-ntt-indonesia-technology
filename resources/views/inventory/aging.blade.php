                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('inventory.aging.download-excel') }}" class="btn btn-success btn-sm">Download
                                Report Excel</a>
                            <a href="{{ route('inventory.aging.download-pdf') }}" class="btn btn-pdf btn-sm"
                            ...
                            <tbody>
                                @foreach ($inventory as $index => $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('inventory.detail', ['id' => $item->id]) }}"
