        ...
        <div class="row">
            <div class="col-12">
                @foreach ($inventory as $index => $inv)
                    <a href="{{ route('inventory.indexDetail.movement.mobile', ['id' => $inv->id]) }}">
                        <div class="card inventory-card mb-2">
                            <div class="card-body p-2">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <div>
                                        <div class="fw-bold"><b>PO : </b>{{ $inv->purchaseOrder->purc_doc }}</div>
                                        <div class="fw-bold"><b>SO : </b>{{ $inv->purchaseOrderDetail->sales_doc }}
                                        </div>
                                    </div>
                                    @if ($inv->type == 'inbound')
                                ...
                                <div class="info-row"><b>Date:</b>
                                    {{ \Carbon\Carbon::parse($inv->created_at)->translatedFormat('d F Y H:i') }}</div>
