...
@section('title', 'Return Spare Room')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Create Spare Room Return</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary" onclick="createOrder()">Create Return Spare Room</a>
                    </div>
                </div>
                <div class="card-body">
        ...
        function createOrder() {
            Swal.fire({
                ...
                if (t.value) {
                    ...
                    $.ajax({
                        url: '{{ route('spare-room.return.store') }}',
                        method: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            products: products,
                        ...
                        success: (res) => {
                            if (res.status) {
                                Swal.fire({
                                    title: 'Success',
                                    text: 'Create Return Spare Room Successfully',
                                    icon: 'success'
                                }).then((e) => {
