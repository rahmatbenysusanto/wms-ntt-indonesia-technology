...
class SpareRoomController extends Controller
{
    ...
    {
        $spareRoom = Outbound::with('customer')
            ->where('type', 'spare room')
        ...
        return view('spare-room.outbound.index', compact('title', 'spareRoom', 'customers'));
    }
    ...
    public function downloadPdf(): \Illuminate\Http\Response
    {
        ...
        $pdf = Pdf::loadView('pdf.spare-room', $data)->setPaper('a4', 'landscape');;
        return $pdf->stream('Spare Room.pdf');
    }
    ...
    public function downloadExcel(): StreamedResponse
    {
        ...
        $fileName = 'Report Spare Room ' . date('Y-m-d H:i:s') . '.xlsx';
