...
Route::middleware(AuthLoginMiddleware::class)->group(function () {
    Route::controller(DashboardController::class)->group(function () {
        ...
        Route::get('/dashboard-stock-sn/download-excel', 'dashboardStockSnDownloadExcel')->name('dashboard.po.stock.sn.download.excel');
    ...
    Route::prefix('/mobile')->group(function () {
        ...
        Route::prefix('/inventory-movement')->controller(InventoryController::class)->group(function () {
            ...
            Route::get('/detail', 'indexDetailMovementMobile')->name('inventory.indexDetail.movement.mobile');
        });
